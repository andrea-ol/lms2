                ...
                <form method="POST" name="edit_id" id="edit_id" action="actualizar_acti.php">
                    <div class="table-responsive">
                        ...
                        if ($rol_user == 'editingteacher') {
                            $curso = $id_curso;
                            $titulos = $conn->query("SELECT name, id FROM mdl_assign WHERE course= " . $curso);
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            foreach ($actividades as $actividad) : ?>
                                                <td>
                                                    <?php
                                                    $q_gradess = $conn->query("SELECT DISTINCT userid, assignment, grade FROM mdl_assign_grades WHERE userid = $user->id AND assignment = $actividad->id");
