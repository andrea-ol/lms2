                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="POST" action="login_config.php">
                                            ...
                                            <!-- <div class="form-floating mb-3">
                                                <input class="form-control" name="email_login" type="email" placeholder="name@example.com" />
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Sena LMS &copy; <?php $currentDate = new DateTime();$currentYear = $currentDate->format("Y"); echo $currentYear;
                                ?></div>
                            <div>
